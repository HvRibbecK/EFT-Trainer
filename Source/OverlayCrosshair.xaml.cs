...
// Habe mich hier noch nicht durchgefuchst. Stand 25.03.2020
// Original GitHub THread: https://github.com/gmastergreatee/ExternalCrosshairOverlay
...
namespace EFT_Trainer
{
    ...
    public partial class OverlayCrosshair : Window
    {
        ...
        /// <param name="index">Unknown to me(haze) what this does</param>
        /// <returns></returns>
        [DllImport("user32.dll")]
